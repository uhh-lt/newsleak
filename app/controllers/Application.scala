  ...
  def jsRoutes(varName: String = "jsRoutes") = Action { implicit request =>
    ...
    Ok(
      JavaScriptReverseRouter(varName)(
        ...
        controllers.routes.javascript.KeywordNetworkController.mergeEntitiesByIdKeyword,
        ...
        controllers.routes.javascript.KeywordNetworkController.getEdgeKeywordsKeyword,
        controllers.routes.javascript.KeywordNetworkController.getNeighborCountsKeyword,
        controllers.routes.javascript.KeywordNetworkController.getNeighborsKeyword,
